...
import com.appyhigh.feedly.CATEGORY_ENTERTAINMENT
...
class EntertainmentFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun initViews(view: View) {
        ...
        recyclerView!!.addOnItemTouchListener(
            RecyclerTouchListener(activity, recyclerView!!, object : RecyclerTouchListener.ClickListener {
    ...
    private fun loadJSON() {
        ...
        if (checkConnection(context)) {
            ...
            val call: Call<NewsResource?>? = request.getCategoryOfHeadlines(Locale.getDefault().country.toString().toLowerCase(),CATEGORY_ENTERTAINMENT, API_KEY)
